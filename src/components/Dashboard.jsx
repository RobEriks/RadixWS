...
const Dashboard = () => {
  return (
    <div className="bg-[#000000] text-white px-6 py-4 border-b border-gray-800 flex justify-between items-center pr-20">
      <div className="flex items-center gap-4">
        <DropdownMenu>
          ...
          <DropdownMenuContent className="bg-gray-800 text-white p-2 rounded-md">
            ...
            <DropdownMenuSeparator className="my-2 border-t border-gray-600" />
            <DropdownMenuItem shortcut="⌘ ⌫" color="red" className="hover:bg-gray-700 p-2 rounded text-red-500">
              Delete
            </DropdownMenuItem>
          </DropdownMenuContent>
        </DropdownMenu>
